...
const ROLES_MODERADORES = ["PROPIETARIO", "owner", "ADMIN"]

export class PublicacionComentarioEntity {
  readonly id: string
  ...
  constructor(raw: PublicacionComentarioRaw) {
    this.id = raw.id
  ...
  static fromPrisma(raw: PublicacionComentarioRaw): PublicacionComentarioEntity {
    return new PublicacionComentarioEntity(raw)
  }
