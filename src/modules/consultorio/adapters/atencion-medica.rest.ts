...
export const atencionMedicaRouter = new OpenAPIHono<HonoEnv>()
...
atencionMedicaRouter.openapi(
  createRoute({
    method: "get",
    path: "/atenciones",
    operationId: "consultorio_get_atenciones",
    tags: ["Consultorio"],
    security: [{ bearerAuth: [] }],
    responses: {
      200: okResponse("Lista de atenciones médicas", z.object({ data: z.array(z.record(z.string(), z.unknown())) })),
      ...errorResponses,
    },
  }),
  async (c) => {
...
atencionMedicaRouter.openapi(
  createRoute({
    method: "post",
    path: "/atenciones",
    operationId: "consultorio_post_atencion",
    tags: ["Consultorio"],
    security: [{ bearerAuth: [] }],
    responses: {
      201: createdResponse("Atención médica creada", z.record(z.string(), z.unknown())),
      ...errorResponses,
    },
  }),
  async (c) => {
...
atencionMedicaRouter.openapi(
  createRoute({
    method: "get",
    path: "/atenciones/{id}",
    operationId: "consultorio_get_atencion",
    tags: ["Consultorio"],
    security: [{ bearerAuth: [] }],
    responses: {
      200: okResponse("Atención médica", z.record(z.string(), z.unknown())),
      ...errorResponses,
    },
  }),
  async (c) => {
...
atencionMedicaRouter.openapi(
  createRoute({
    method: "patch",
    path: "/atenciones/{id}",
    operationId: "consultorio_patch_atencion",
    tags: ["Consultorio"],
    security: [{ bearerAuth: [] }],
    responses: {
      200: okResponse("Atención médica actualizada", z.record(z.string(), z.unknown())),
      ...errorResponses,
    },
  }),
  async (c) => {
...
atencionMedicaRouter.openapi(
  createRoute({
    method: "post",
    path: "/atenciones/{id}/pagos",
    operationId: "consultorio_post_atencion_pago",
    tags: ["Consultorio"],
    security: [{ bearerAuth: [] }],
    responses: {
      200: okResponse("Pago registrado", z.record(z.string(), z.unknown())),
      ...errorResponses,
    },
  }),
  async (c) => {
...
atencionMedicaRouter.openapi(
  createRoute({
    method: "post",
    path: "/atenciones/{id}/anular",
    operationId: "consultorio_post_atencion_anular",
    tags: ["Consultorio"],
    security: [{ bearerAuth: [] }],
    responses: {
      200: okResponse("Atención anulada", z.record(z.string(), z.unknown())),
      ...errorResponses,
    },
  }),
  async (c) => {
